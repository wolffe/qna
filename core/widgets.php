...
class QA_Widget_Questions extends QA_Widget_Helper {
	...
	function __construct() {
		...
		parent::__construct( 'questions', __( 'Q&A: Questions', QA_TEXTDOMAIN ), $widget_ops );
	...
	function form( $instance ) {
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'categories' ); ?>"><?php _e( 'Categories:', QA_TEXTDOMAIN ); ?></label>
			<?php
			echo _qa_html( 'input', array(
				'type'  => 'text',
				'size'  => 30,
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of questions to show:', QA_TEXTDOMAIN ); ?></label>
			<?php
			echo _qa_html( 'input', array(
				'type'  => 'text',
				'size'  => 2,
...
class QA_Widget_Tags extends QA_Widget_Helper {
	...
	function __construct() {
		...
		parent::__construct( 'question_tags', __( 'Q&A: Question Tags', QA_TEXTDOMAIN ), $widget_ops );
	}
...
class QA_Widget_Categories extends QA_Widget_Helper {
	...
	function __construct() {
		...
		parent::__construct( 'question_categories', __( 'Q&A: Question Categories', QA_TEXTDOMAIN ), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		<label
			for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'Show question counts', QA_TEXTDOMAIN ); ?></label>
		<br/>
		<?php
	}
...
class QA_Widget_Reputation extends QA_Widget_Helper {
	...
	function __construct() {
		...
		parent::__construct ( 'question_reputation', __( 'Q&A: Users with Highest Reputation', QA_TEXTDOMAIN ), $widget_ops );
	}
