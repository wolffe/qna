...
<?php foreach ($INLINE_TABS as $_INLINE_TAB_NAME => $_INLINE_TAB):?>
    <div class="sabai-tab-pane sabai-fade<?php if ($_INLINE_TAB_NAME == $INLINE_TAB_CURRENT):?> sabai-in  sabai-active<?php endif;?>" id="sabai-inline-content-<?php echo $_INLINE_TAB_NAME;?>">
